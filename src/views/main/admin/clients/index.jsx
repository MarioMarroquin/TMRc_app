...
import NewClientDialog from '@views/main/admin/clients/components/newClientDialog';
import { useQuery } from '@apollo/client';
import { GET_CLIENTS } from '@views/main/admin/clients/requests';
import ClientCard from '@views/main/admin/clients/components/clientCard';
